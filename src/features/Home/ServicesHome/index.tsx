  ...
  return (
    <div className="relative z-40 bg-white">
      <div className="flex flex-col gap-6 py-10 px-6 lg:px-10 lg:py-20 2xl:px-20">
        <div className="flex flex-col gap-8 lg:gap-12 w-full 2xl:pt-40">
          {/* Título - separado para alinhar imagem com o texto */}
          <h2
            className={cn(
              "text-dark font-semibold leading-tight uppercase max-w-4xl",
              "text-3xl md:text-5xl",
              "lg:text-6xl 2xl:text-7xl",
              "lg:ml-auto lg:text-right lg:w-[60%] lg:pl-8"
            )}
          >
            {t.home.servicesHome.title}
          </h2>

          {/* Conteúdo: Imagem + Texto lado a lado */}
